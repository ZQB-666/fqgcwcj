...
//百度地图
 //创建和初始化地图函数：
    ...
    function createMap(){ 
      ...
      map.centerAndZoom(new BMap.Point(116.359977,40.060689),11);
    }
    ...
    function addMapOverlay(){
      var markers = [
        {content:"北京市海淀区清华同方大酒店",title:"分期购车",imageOffset: {width:0,height:3},position:{lat:39.928026,lng:116.397346}}
      ];
